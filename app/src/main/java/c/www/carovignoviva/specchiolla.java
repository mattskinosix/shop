...
public class specchiolla extends AppCompatActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        final getInfoMarkerSpec markerCarovig = new getInfoMarkerSpec(mMap);
        ...
        mMap.setOnInfoWindowClickListener(new GoogleMap.OnInfoWindowClickListener() {
            ...
            public void onInfoWindowClick(Marker arg0) {
                AlertDialog ad = new AlertDialog.Builder(specchiolla.this).create();
