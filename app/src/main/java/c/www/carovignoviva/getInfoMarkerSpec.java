...
public class getInfoMarkerSpec extends AppCompatActivity {
    public ArrayList<Marker> markersCarovigno;
    Context context;
    ArrayList<InfoWindowData> data = new ArrayList<>();
    public getInfoMarkerSpec(GoogleMap mMap){
        context=this;
        markersCarovigno=new ArrayList<>();

        markersCarovigno.add(mMap.addMarker(new MarkerOptions()
                .title("Specchiolla(Località marittima)")
                .position(new LatLng(40.742863, 17.734987))));
