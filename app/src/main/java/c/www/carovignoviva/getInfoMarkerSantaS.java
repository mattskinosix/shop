...
public class getInfoMarkerSantaS extends AppCompatActivity {
    public ArrayList<Marker> markersCarovigno;
    Context context;
    ArrayList<InfoWindowData> data = new ArrayList<>();
    public getInfoMarkerSantaS(GoogleMap mMap){
        context=this;
        markersCarovigno=new ArrayList<>();

        markersCarovigno.add(mMap.addMarker(new MarkerOptions()
                .title("Santa Sabina (Località Marittima)")
                .position(new LatLng(40.75506, 17.70435))));
